...
export class DashboardComponent implements OnInit {
   ...
   * o que permite a integração de API com angular
   *
   * @return void
   */
  init(): void {
  ...
  /**
   * Cria e retona o objeto DataTable da API de gráficos,
  ...
  /**
   * Retorna as opçoes do gráfico, que incluem o título
